                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                      <div className="space-y-2">
                        ...
                        <input className="w-full px-7 py-4 rounded-full bg-[#fbf9f6] border border-[#1a1c24]/10 text-sm font-outfit" placeholder="Tirunelveli" />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <input className="w-full px-7 py-4 rounded-full bg-[#fbf9f6] border border-[#1a1c24]/10 text-sm font-outfit" placeholder="627001" />
                      </div>
                    </div>
                  </div>
