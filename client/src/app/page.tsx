...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background font-sans selection:bg-primary/20 overflow-x-hidden">
        ...
        <div className="relative z-30 flex flex-col items-center text-center px-6 max-w-6xl">
          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="text-2xl md:text-4xl lg:text-5xl min-[1200px]:text-[50px] 2xl:text-5xl font-fraunces font-black leading-[1.05] tracking-tight text-[#1a1c24] italic">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 pt-6 md:pt-10">
              <Link href="/boutique" className="w-full sm:w-auto group/btn relative px-10 py-5 bg-[#1a1c24] text-white rounded-full font-black text-[10px] md:text-xs uppercase tracking-[0.3em] overflow-hidden shadow-xl hover:scale-105 active:scale-95 transition-all">
                 ...
                 <span className="relative z-10 flex items-center justify-center gap-3">
                    The Atelier <ArrowRight className="w-5 h-5 group-hover/btn:translate-x-1.5 transition-transform" />
                 </span>
              </Link>
              <Link href="/bakery" className="w-full sm:w-auto px-10 py-5 border-2 border-[#1a1c24]/5 bg-white text-[#1a1c24] rounded-full font-black text-[10px] md:text-xs uppercase tracking-[0.3em] hover:border-[#ff4d6d] hover:bg-[#ff4d6d]/5 shadow-lg hover:scale-105 active:scale-95 transition-all italic">
                 The Sanctum
              </Link>
            </div>
          </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-32 gap-10 md:gap-16">
            <div className="space-y-6 md:space-y-8">
              ...
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-fraunces font-black text-[#1a1c24] leading-[1.1] tracking-tight italic">
              ...
              >
                 <div className="relative aspect-[4/5] overflow-hidden rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.08)] bg-[#fbf9f6] transition-all duration-700 hover:-translate-y-4 border border-[#1a1c24]/5 active:scale-95">
                    ...
                    <div className="absolute inset-x-0 bottom-6 flex justify-center translate-y-full group-hover:translate-y-0 transition-transform duration-500 px-8">
                       <button className="w-full py-3 bg-white/95 backdrop-blur-md text-[#1a1c24] rounded-full font-black text-[9px] uppercase tracking-[0.25em] shadow-xl border border-white/20 italic hover:bg-[#ff4d6d] hover:text-white transition-colors">Swift Manifest</button>
                    </div>
                 </div>
      ...
      <section className="py-12 md:py-20 bg-[#fbf9f6] overflow-hidden relative">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
            ...
            <div className="relative h-[450px] md:h-[750px] order-1">
               ...
               >
                 <img src="https://anyaonline.in/cdn/shop/files/WhatsApp_Image_2026-02-23_at_12.02.24_PM_800x.jpg?v=1771828434" alt="Boutique Collection" className="w-full h-full object-cover hover:scale-110 transition-transform duration-[2s]" loading="lazy" />
               </motion.div>
               <motion.div
                 initial={{ opacity: 0, scale: 0.9 }}
                 whileInView={{ opacity: 1, scale: 1 }}
               ...
               >
                 <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80" alt="Boutique Style" className="w-full h-full object-cover hover:scale-110 transition-transform duration-[2s]" loading="lazy" />
               </motion.div>
            ...
            >
              ...
              <Link href="/boutique" className="group relative inline-flex items-center justify-center gap-6 w-full sm:w-auto px-10 py-5 bg-[#1a1c24] text-white rounded-full font-black text-[10px] md:text-xs uppercase tracking-[0.3em] hover:scale-105 active:scale-95 transition-all shadow-xl overflow-hidden">
                 <div className="absolute inset-0 bg-[#ff4d6d]/10 -translate-x-full group-hover:translate-x-0 transition-transform duration-500" />
                 <span className="relative z-10 flex items-center justify-center gap-4">Manifest Your Style <ArrowRight className="w-5 h-5 group-hover:translate-x-1.5 transition-transform" /></span>
              </Link>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10">
          <div className="text-center mb-20 md:mb-32 space-y-8 md:space-y-12">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-5xl font-fraunces font-black text-[#1a1c24] leading-tight italic">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16">
            ...
            >
              <img src="https://images.pexels.com/photos/291528/pexels-photo-291528.jpeg?auto=compress&cs=tinysrgb&w=800" alt="Lotus Biscoff Cake" className="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-110" loading="lazy" />
              ...
              <div className="absolute bottom-12 md:bottom-20 left-10 md:left-16 right-10 md:right-16 space-y-6">
                ...
                <button className="px-8 py-4 bg-white text-[#1a1c24] rounded-full font-black text-[9px] uppercase tracking-[0.3em] italic mt-6 hover:bg-[#ff4d6d] hover:text-white transition-all shadow-xl">Order Ritual</button>
              </div>
            </motion.div>
          ...
          <div className="text-center mt-20 md:mt-32">
            <Link href="/bakery" className="group relative inline-flex items-center justify-center gap-6 w-full sm:w-auto px-10 py-5 border-2 border-[#1a1c24]/5 bg-white text-[#1a1c24] rounded-full font-black text-[10px] md:text-xs uppercase tracking-[0.3em] hover:bg-[#ff4d6d]/5 hover:border-[#ff4d6d] hover:scale-105 active:scale-95 transition-all shadow-lg italic">
              Explore Full Sanctum Menu <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-16">
            {[
              ...
              >
                <div className="text-3xl md:text-5xl group-hover:scale-125 group-hover:rotate-12 transition-transform duration-700 w-fit">{item.emoji}</div>
