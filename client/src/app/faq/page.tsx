...
const faqs = [
  {
    ...
    items: [
      ...
      { q: 'Can I request a specific fabric for a gown?', a: 'Yes! Our Boutique offers bespoke tailoring. You can schedule a consultation at our Coimbatore studio to select fabrics and discuss measurements.' }
    ]
  },
  {
    category: 'Delivery & Shipping',
    items: [
      { q: 'Where do you deliver?', a: 'We deliver Bakery and Homemade items within Coimbatore city limits. Boutique items are shipped pan-India via our courier partners.' },
