    ...
    <main className="min-h-screen bg-[#fbf9f6] text-[#1a1c24]">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-[1500px] mx-auto px-10">
          ...
          <Link href="/homemade" className="inline-flex items-center gap-2 text-[10px] font-outfit font-black uppercase tracking-[0.3em] text-[#1a1c24]/30 hover:text-[#ff4d6d] transition-colors mb-12">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <motion.div 
               ...
               className="aspect-square rounded-[3.5rem] overflow-hidden shadow-soft border border-[#1a1c24]/5 bg-white p-12"
            >
               <img src={product.img} alt={product.name} className="w-full h-full object-contain transition-transform duration-1000 group-hover:scale-105" />
            </motion.div>
            ...
            <div className="space-y-12">
               <div className="space-y-4">
                  <div className="flex items-center gap-3">
                     <span className="px-3 py-1 bg-[#1a1c24]/5 text-[#1a1c24]/60 text-[9px] font-outfit font-black uppercase tracking-widest rounded-full">{product.category} Palace</span>
                  ...
                  <div className="flex items-baseline gap-4">
                     ...
                     <span className="text-sm font-outfit text-[#1a1c24]/20 uppercase tracking-[0.2em]">/ {product.unit}</span>
                  </div>
               </div>
               ...
               <div className="flex flex-wrap gap-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-2 px-6 py-3 rounded-full bg-white border border-[#1a1c24]/5 shadow-sm text-[10px] font-outfit font-black uppercase tracking-widest text-[#1a1c24]/40 hover:border-[#ff4d6d] transition-all cursor-default">
               ...
               <p className="text-[10px] font-outfit font-black uppercase tracking-[0.4em] text-[#1a1c24]/20 flex items-center gap-3">
      ...
      <section className="py-24 bg-white border-y border-[#1a1c24]/5">
         <div className="max-w-[1500px] mx-auto px-10">
            <div className="max-w-3xl mx-auto text-center space-y-12">
               <h3 className="text-3xl font-fraunces font-bold italic text-[#bfa37e]">The Recipe Story</h3>
               <p className="text-lg font-outfit text-[#1a1c24]/50 leading-relaxed max-w-2xl mx-auto italic font-medium">
                  "Our {product.name} is prepared using a three-generation old recipe from our founder's family kitchen in Coimbatore. Every batch is handmade in small quantities to ensure that the aroma and taste remain exactly like home."
               </p>
               <div className="w-px h-20 bg-gradient-to-b from-[#bfa37e] to-transparent mx-auto" />
            </div>
         </div>
      </section>
