  ...
  return (
    <main className="min-h-screen bg-[#fbf9f6] overflow-x-hidden">
      ...
      <footer className="py-10 md:py-16 bg-[#fbf9f6] border-t border-[#1a1c24]/5 text-center px-6">
        <p className="text-[9px] md:text-[10px] font-outfit font-black uppercase tracking-[0.5em] text-[#1a1c24]/20 italic line-clamp-1">© 2026 PRANAVIKA'S Sweet & Chic — Member Atelier</p>
      </footer>
    </main>
  );
}
