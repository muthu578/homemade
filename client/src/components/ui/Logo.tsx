  ...
  return (
    <Link href="/" className={`flex items-center gap-4 group transition-all duration-700 ${className}`}>
      ...
      <div className="relative w-12 h-12 md:w-16 md:h-16 flex-shrink-0 group-hover:rotate-6 transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)]">
        ...
        />
        {/* Subtle Artisan Glow */}
        <div className="absolute inset-0 bg-[#ff4d6d]/10 blur-[20px] opacity-0 group-hover:opacity-100 transition-opacity duration-1000 rounded-full scale-125 -z-10" />
      </div>

      {/* Brand Text Wrapper */}
      <div className="flex flex-col">
        <span className="text-xl md:text-2xl font-fraunces font-black leading-none tracking-tight text-[#1a1c24] group-hover:text-[#ff4d6d] transition-colors duration-500">
          PRANAVIKA'S
        </span>
