    ...
    <footer className="bg-white pt-24 pb-12 overflow-hidden border-t border-[#1a1c24]/5">
      <div className="max-w-[1800px] mx-auto px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-2 grid grid-cols-2 gap-8 lg:gap-16">
            {/* Collections */}
            <div className="space-y-6 md:space-y-8">
              <h4 className="text-[10px] font-outfit font-black uppercase tracking-[0.4em] text-[#efb5b5]">Our World</h4>
            ...
            {/* Support */}
            <div className="space-y-6 md:space-y-8">
              <h4 className="text-[10px] font-outfit font-black uppercase tracking-[0.4em] text-[#efb5b5]">Guest Care</h4>
              <ul className="space-y-3 md:space-y-4">
        ...
        {/* Bottom Bar */}
        <div className="pt-3 border-t border-[#1a1c24]/5 flex flex-col md:flex-row items-center justify-between gap-6 opacity-40">
